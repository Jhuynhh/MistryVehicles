...
<div class="container-fluid">
    ...
    <div class="container container-first">
        <div class="row">
            <div class="container">
                <h1 style="color: #C0C0C0">Lamborghini Egoista</h1>
                <hr>
            </div>
        </div>
                ...
                <div id="demo" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="Lambo_Egoista/Egoista_Img_1.jpg" alt="McLaren Image 1">
                        </div>
                        <div class="carousel-item">
                            <img src="Lambo_Egoista/Egoista_Img_2.jpg" alt="McLaren Image 2">
                        </div>
                        <div class="carousel-item">
                            <img src="Lambo_Egoista/Egoista_Img_3.jpg" alt="McLaren Image 3">
                        </div>
                    </div>
