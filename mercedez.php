...
<div class="container-fluid">
    ...
    <div class="container container-first">
        <div class="row">
            <div class="container">
                <h1 style="color: #C0C0C0">Mercedez F015</h1>
                <hr>
            </div>
        </div>
                ...
                <div id="demo" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="Mercedez F015/Merc_Img_1.jpg" alt="Mercedez Image 1" width="1100" height="500">
                        </div>
                        <div class="carousel-item">
                            <img src="Mercedez F015/Merc_Img_3.jpg" alt="Mercedez Image 2" width="1100" height="500">
                        </div>
                        <div class="carousel-item">
                            <img src="Mercedez F015/Merc_Img_4.jpg" alt="Mercedez Image 3" width="1100" height="500">
                        </div>
                    </div>
